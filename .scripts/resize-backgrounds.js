...
var image640x360 = 'us-attorneys-general/images/backgrounds/640x360/';
var image960x540 = 'us-attorneys-general/images/backgrounds/960x540/';
var image1280x720 = 'us-attorneys-general/images/backgrounds/1280x720/';
var image1920x1080 = 'us-attorneys-general/images/backgrounds/1920x1080/';

glob('source/us-attorneys-general.jpg', {}, function (er, files) {
  if (files.length === 0) {
    console.log('× No background images to convert');
  } else {
    for (var i = 0; i < files.length; i++) {
      var fullSizeImage = files[i];
      var fileName = 'us-attorneys-general.jpg';
