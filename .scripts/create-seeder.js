...
var collection, data;
var seeder_file = path.join(__dirname, '../us-attorneys-general/data/20170101000000-senate-seeder.js');
var data_file = path.join(__dirname, '../us-attorneys-general/data/us-attorneys-general.json');
