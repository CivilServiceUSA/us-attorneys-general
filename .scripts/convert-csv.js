...
var converted = 'us-attorneys-general/data/us-attorneys-general.csv';
var currentRow = 0;
  ...
  fs.truncate(converted, 0, function() {
    ...
    csv.fromStream(stream, {headers : true}).validate(function(data){
      ...
      .on('data', function(data){
        ...
        var cdnHeadshotPath = (data.vacant === 'yes') ? '' : 'https://cdn.civil.services/us-attorneys-general/headshots/512x512/' +
